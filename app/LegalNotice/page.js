			...
			<div className="bg-gray-100 text-slate-900">
				<div className="container mx-auto py-8">
					...
					<div className="bg-white p-6 m-2 shadow-neutral-950 shadow-lg">
						...
						<p className="mb-4">
							If you have any questions or concerns about our payment processing or this legal notice, please contact us at <a href="mailto:thegemlins@gmail.com" className="text-blue-500">thegemlins@gmail.com</a>.
						</p>
